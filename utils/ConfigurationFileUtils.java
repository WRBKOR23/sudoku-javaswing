...
public class ConfigurationFileUtils
{
    ...
    public static void readInitConfigFile() throws IOException
    {
        ...
        try
        {
            fr = new FileReader(Constants.INIT_FILE_LOCATION);
            ...
            while ((line = br.readLine()) != null)
            {
                if (line.startsWith(Constants.DB_DRIVER))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_DRIVER = data[1].trim();
                    }
                    else
                    {
                ...
                if (line.startsWith(Constants.DB_URL))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_URL = data[1].trim();
                    }
                    else
                    {
                ...
                if (line.startsWith(Constants.DB_NAME))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_NAME = data[1].trim();
                    }
                    else
                    {
                ...
                if (line.startsWith(Constants.DB_TIME_ZONE))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_TIME_ZONE = data[1].trim();
                    }
                    else
                    {
                ...
                if (line.startsWith(Constants.DB_USER))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_USER = data[1].trim();
                    }
                    else
                    {
                ...
                if (line.startsWith(Constants.DB_PASS))
                {
                    ...
                    if (data.length == 2)
                    {
                        Constants.InitConfiguration.DB_PASS = data[1].trim();
                    }
                    else
                    {
